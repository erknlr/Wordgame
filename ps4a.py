...
def getWordScore(word, n):
    ...
    if len(word) == 0:
        ...
        if len(word) == n:
            word_score = (word_score * len(word)) + 50
        else:
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(x, hand, wordList):
                ...
                word_score = getWordScore(x, n)
                total_score += word_score
                print('"',x,'" ','earned ', word_score, ' points. Total: ', total_score, ' points', sep='')
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    while x != 'e':
        ...
        if x == 'e':
            break
        elif x != 'n' and x != 'e' and x != 'r':
            print('Invalid command.')
        elif x == 'r' and (x_former != 'r' and x_former != 'n'):
            print('You have not played a hand yet. Please play a new hand first!')
        elif x == 'n':
            # Save the current hand in case user wants to repeat it
